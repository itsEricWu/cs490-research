...
def main():
    ...
    for path, dir_list, file_list in g:
        for file_name in file_list:
            ...
            df.loc[len(df.index)] = [file_name, original_label, output_label_y, np.identity(3), 0]
            df.loc[len(df.index)] = [file_name, original_label, output_label_y_new, np.identity(3), alpha]
            df.loc[len(df.index)] = [file_name, original_label, output_label_x, v, 0]
            df.loc[len(df.index)] = [file_name, original_label, output_label_x_new, v, alpha]
